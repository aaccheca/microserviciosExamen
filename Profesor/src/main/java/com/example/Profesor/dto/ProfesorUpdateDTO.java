...
/**
 * DTO para la actualización completa de un profesor (PUT).
...
public class ProfesorUpdateDTO {
    ...
    // Constructores
    public ProfesorUpdateDTO() {
    }

    public ProfesorUpdateDTO(String nombre, String apellido, String email, String especialidad, String telefono) {
        this.nombre = nombre;
